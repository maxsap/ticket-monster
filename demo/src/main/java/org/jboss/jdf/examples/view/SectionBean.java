...
public class SectionBean implements Serializable
{
   ...
   public String delete()
   {
      ...
      try
      {
         this.entityManager.remove(this.entityManager.find(Section.class, getId()));
   ...
   public void paginate()
   {
      ...
      TypedQuery<Section> query = this.entityManager.createQuery(criteria.select(root).where(getSearchPredicates(root)));
   ...
   public List<Section> getAll()
   {
      ...
      CriteriaQuery<Section> criteria = this.entityManager.getCriteriaBuilder().createQuery(Section.class);
      return this.entityManager.createQuery(criteria.select(criteria.from(Section.class))).getResultList();
   }
   ...
   public Converter getConverter()
   {
      ...
      return new Converter()
      {
         ...
         public Object getAsObject(FacesContext context, UIComponent component, String value)
         {
            ...
            return SectionBean.this.entityManager.find(Section.class, Long.valueOf(value));
         }
