...
public class SectionAllocationBean implements Serializable
{
   ...
   public String delete()
   {
      ...
      try
      {
         this.entityManager.remove(this.entityManager.find(SectionAllocation.class, getId()));
   ...
   public void paginate()
   {
      ...
      TypedQuery<SectionAllocation> query = this.entityManager.createQuery(criteria.select(root).where(getSearchPredicates(root)));
   ...
   public List<SectionAllocation> getAll()
   {
      ...
      CriteriaQuery<SectionAllocation> criteria = this.entityManager.getCriteriaBuilder().createQuery(SectionAllocation.class);
      return this.entityManager.createQuery(criteria.select(criteria.from(SectionAllocation.class))).getResultList();
   }
   ...
   public Converter getConverter()
   {
      ...
      return new Converter()
      {
         ...
         public Object getAsObject(FacesContext context, UIComponent component, String value)
         {
            ...
            return SectionAllocationBean.this.entityManager.find(SectionAllocation.class, Long.valueOf(value));
         }
