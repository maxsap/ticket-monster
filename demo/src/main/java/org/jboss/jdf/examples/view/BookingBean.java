...
public class BookingBean implements Serializable
{
   ...
   public void retrieve()
   {
      ...
      if (this.id == null)
      {
         this.booking = this.search;
      }
      else
      {
         this.booking = this.entityManager.find(Booking.class, getId());
      }
   }
   ...
   public String delete()
   {
      ...
      try
      {
         this.entityManager.remove(this.entityManager.find(Booking.class, getId()));
   ...
   private Booking search = new Booking();
   ...
   public Booking getSearch()
   {
      return this.search;
   }

   public void setSearch(Booking search)
   {
      this.search = search;
   }
   ...
   private Predicate[] getSearchPredicates(Root<Booking> root)
   {
      ...
      String cancellationCode = this.search.getCancellationCode();
   ...
   public Converter getConverter()
   {
      ...
      return new Converter()
      {
         ...
         public Object getAsObject(FacesContext context, UIComponent component, String value)
         {
            ...
            return BookingBean.this.entityManager.find(Booking.class, Long.valueOf(value));
         }
