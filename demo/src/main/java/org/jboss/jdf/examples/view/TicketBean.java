...
public class TicketBean implements Serializable
{
   ...
   public void retrieve()
   {
      ...
      {
         this.ticket = this.entityManager.find(Ticket.class, getId());
      }
   }
   ...
   public String delete()
   {
      ...
      try
      {
         this.entityManager.remove(this.entityManager.find(Ticket.class, getId()));
   ...
   private Ticket search = new Ticket();
   ...
   public Ticket getSearch()
   {
      return this.search;
   }

   public void setSearch(Ticket search)
   {
      this.search = search;
   }
   ...
   public Converter getConverter()
   {
      ...
      return new Converter()
      {
         ...
         public Object getAsObject(FacesContext context, UIComponent component, String value)
         {
            ...
            return TicketBean.this.entityManager.find(Ticket.class, Long.valueOf(value));
         }
