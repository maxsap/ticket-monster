...
public class PerformanceBean implements Serializable
{
   ...
   public String delete()
   {
      ...
      try
      {
         this.entityManager.remove(this.entityManager.find(Performance.class, getId()));
   ...
   public void paginate()
   {
      ...
      TypedQuery<Performance> query = this.entityManager.createQuery(criteria.select(root).where(getSearchPredicates(root)));
   ...
   public List<Performance> getAll()
   {
      ...
      CriteriaQuery<Performance> criteria = this.entityManager.getCriteriaBuilder().createQuery(Performance.class);
      return this.entityManager.createQuery(criteria.select(criteria.from(Performance.class))).getResultList();
   }
   ...
   public Converter getConverter()
   {
      ...
      return new Converter()
      {
         ...
         public Object getAsObject(FacesContext context, UIComponent component, String value)
         {
            ...
            return PerformanceBean.this.entityManager.find(Performance.class, Long.valueOf(value));
         }
