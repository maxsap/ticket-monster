...
public class MediaItemBean implements Serializable
{
   ...
   public String delete()
   {
      ...
      try
      {
         this.entityManager.remove(this.entityManager.find(MediaItem.class, getId()));
   ...
   public void paginate()
   {
      ...
      TypedQuery<MediaItem> query = this.entityManager.createQuery(criteria.select(root).where(getSearchPredicates(root)));
   ...
   public List<MediaItem> getAll()
   {
      ...
      CriteriaQuery<MediaItem> criteria = this.entityManager.getCriteriaBuilder().createQuery(MediaItem.class);
      return this.entityManager.createQuery(criteria.select(criteria.from(MediaItem.class))).getResultList();
   }
   ...
   public Converter getConverter()
   {
      ...
      return new Converter()
      {
         ...
         public Object getAsObject(FacesContext context, UIComponent component, String value)
         {
            ...
            return MediaItemBean.this.entityManager.find(MediaItem.class, Long.valueOf(value));
         }
