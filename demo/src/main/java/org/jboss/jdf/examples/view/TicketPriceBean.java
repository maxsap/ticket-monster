...
public class TicketPriceBean implements Serializable
{
   ...
   public void retrieve()
   {
      ...
      if (this.id == null)
      {
         this.ticketPrice = this.search;
      }
      else
      {
         this.ticketPrice = this.entityManager.find(TicketPrice.class, getId());
      }
   }
   ...
   public String delete()
   {
      ...
      try
      {
         this.entityManager.remove(this.entityManager.find(TicketPrice.class, getId()));
   ...
   private TicketPrice search = new TicketPrice();
   ...
   public TicketPrice getSearch()
   {
      return this.search;
   }

   public void setSearch(TicketPrice search)
   {
      this.search = search;
   }
   ...
   public Converter getConverter()
   {
      ...
      return new Converter()
      {
         ...
         public Object getAsObject(FacesContext context, UIComponent component, String value)
         {
            ...
            return TicketPriceBean.this.entityManager.find(TicketPrice.class, Long.valueOf(value));
         }
