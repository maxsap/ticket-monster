...
public class EventBean implements Serializable
{
   ...
   public String delete()
   {
      ...
      try
      {
         this.entityManager.remove(this.entityManager.find(Event.class, getId()));
   ...
   private Predicate[] getSearchPredicates(Root<Event> root)
   {
      ...
      MediaItem mediaItem = this.search.getMediaItem();
      if (mediaItem != null)
      {
   ...
   public Converter getConverter()
   {
      ...
      return new Converter()
      {
         ...
         public Object getAsObject(FacesContext context, UIComponent component, String value)
         {
            ...
            return EventBean.this.entityManager.find(Event.class, Long.valueOf(value));
         }
