...
public class ShowBean implements Serializable
{
   ...
   public void retrieve()
   {
      ...
      {
         this.show = this.entityManager.find(Show.class, getId());
      }
   }
   ...
   public String delete()
   {
      ...
      try
      {
         this.entityManager.remove(this.entityManager.find(Show.class, getId()));
   ...
   public Show getSearch()
   {
      return this.search;
   }

   public void setSearch(Show search)
   {
      this.search = search;
   }
   ...
   private Predicate[] getSearchPredicates(Root<Show> root)
   {
      ...
      Event event = this.search.getEvent();
      if (event != null)
      {
   ...
   public Converter getConverter()
   {
      ...
      return new Converter()
      {
         ...
         public Object getAsObject(FacesContext context, UIComponent component, String value)
         {
            ...
            return ShowBean.this.entityManager.find(Show.class, Long.valueOf(value));
         }
