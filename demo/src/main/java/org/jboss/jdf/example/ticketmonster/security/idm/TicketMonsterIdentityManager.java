...
package org.jboss.jdf.example.ticketmonster.security.idm;
 ...
 *
 */
public class TicketMonsterIdentityManager implements IdentityManager {
    ...
    public PicketBoxSubject getIdentity(PicketBoxSubject resultingSubject) {
        ...
        roles.add(resultingSubject.getUser().getName());
